**用户：** 参考 `/Users/lord/WiseNET/个人收纳物品整理/ai-inventory-app/2.后台Python/v1_add_box.py` `/Users/lord/WiseNET/个人收纳物品整理/ai-inventory-app/2.后台Python/v1_edit_box.py` ，新增接口v1_get_box.py，需要整合到launch.py中。 
